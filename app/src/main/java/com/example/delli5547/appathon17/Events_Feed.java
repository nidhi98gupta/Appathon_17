...
import com.example.delli5547.appathon17.adapter.adapter_event;
...
public class Events_Feed extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    private List<event> eventList = new ArrayList<>();
    private RecyclerView recyclerView;
    private adapter_event mAdapter;

    ArrayList<event> marraylist;
    Button btnDate;
    String event_date;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new adapter_event(eventList);
...
//        Log.d("ArryList", "Array" + jsonArray.toString());
        ...
        if (check) {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                event items = new event(event_name, date, start_time, end_time, day, description, organizer, location);
                marraylist.add(items);

            }

            adapter_event customAdapter = new adapter_event(marraylist);
